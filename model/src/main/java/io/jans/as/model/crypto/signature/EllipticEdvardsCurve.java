...
public enum EllipticEdvardsCurve {
    ...
    P_256("P-256", "secp256r1", "1.2.840.10045.3.1.7"), P_256K("P-256K", "secp256k1", "1.3.132.0.10"),
    P_384("P-384", "secp384r1", "1.3.132.0.34"), P_521("P-521", "secp521r1", "1.3.132.0.35"),
    ED_25519("Ed25519", "Ed25519", "1.3.101.112"), ED_448("Ed448", "Ed448", "1.3.101.113");
    ...
    /**
     * Returns the corresponding {@link EllipticEdvardsCurve} for a parameter crv of
     * the JWK endpoint.
     *
