...
public enum KeyType {
    ...
    /**
     * The Elliptic Curve Digital Signature Algorithm (ECDSA) is defined by FIPS
     * 186‑3.
     */
    EC("EC"),
    ...
    /**
     * Returns the corresponding {@link KeyType} for a parameter use of the JWK
     * endpoint.
     *
     * @param param The use parameter.
     * @return The corresponding algorithm family if found, otherwise
     *         <code>null</code>.
     */
    @JsonCreator
