...
public enum KeyEncryptionAlgorithm {
    ...
    A128KW("A128KW", AlgorithmFamily.AES), A192KW("A192KW", AlgorithmFamily.AES), A256KW("A256KW", AlgorithmFamily.AES),

    A128GCMKW("A128GCMKW", AlgorithmFamily.AES), A192GCMKW("A192GCMKW", AlgorithmFamily.AES),
